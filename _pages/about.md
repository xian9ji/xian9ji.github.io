...
This is Xiang's home on the web!

I am currently a postdoctoral fellow at Shanghai Jiao Tong University, working in the Laboratory on Fast Algorithms and High-Performance Computing under the supervision of Prof. Zhanli Xu. I obtained my Ph.D. in Computational Mathematics from Soochow University in July 2023. Over the past eight years, I have developed expertise in computational fluid dynamics, multi-physical fluid flow modeling, high-performance computing, and deep-learning-assisted multiscale simulations. 
